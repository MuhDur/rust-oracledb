...
*oracledb::TokenPrivateKey*	keep	Public, redacted credential wrapper for the OCI IAM database-token proof-of-possession private key (paired with AccessToken via with_access_token_and_key).
