...
use oracledb_protocol::thin::{
    ...
    parse_query_response_with_binds_and_options, BindValue, ClientCapabilities, ColumnMetadata,
    ExecuteOptions, LobReadResult, QueryResult, TNS_FUNC_COMMIT, TNS_FUNC_LOGOFF, TNS_FUNC_PING,
